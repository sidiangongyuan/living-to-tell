...
[![Latest release](https://img.shields.io/badge/preview-0.1.53-2563eb?style=flat-square)](https://github.com/sidiangongyuan/living-to-tell/releases/tag/living-to-tell-v0.1.53)
...
[**Download for Windows**](https://github.com/sidiangongyuan/living-to-tell/releases/download/living-to-tell-v0.1.53/LivingToTell_0.1.53_x64-setup.exe)
...
![Motif relationship star map](tauri-mvp/docs/assets/screenshots/motif-star-map.png)
...
- Recommended: [`LivingToTell_0.1.53_x64-setup.exe`](https://github.com/sidiangongyuan/living-to-tell/releases/download/living-to-tell-v0.1.53/LivingToTell_0.1.53_x64-setup.exe)
- MSI package: [`LivingToTell_0.1.53_x64_zh-CN.msi`](https://github.com/sidiangongyuan/living-to-tell/releases/download/living-to-tell-v0.1.53/LivingToTell_0.1.53_x64_zh-CN.msi)
