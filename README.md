...
[![Latest release](https://img.shields.io/badge/preview-0.1.48-2563eb?style=flat-square)](https://github.com/sidiangongyuan/living-to-tell/releases/tag/living-to-tell-v0.1.48)
...
[**Download for Windows**](https://github.com/sidiangongyuan/living-to-tell/releases/download/living-to-tell-v0.1.48/LivingToTell_0.1.48_x64-setup.exe)
...
| **AI Edit** | Article-bound polish, rewrite, expand, and continue tools with a first-class reference-specimen picker, explicit model selection, recoverable multi-model runs, paragraph diff, and versioned write-back. |
...
- Choose reference specimens in a large searchable picker before a run. Only confirmed specimens are attached, every model receives the same frozen set, and the prompt forbids copying sentences or importing specimen facts and names.
...
- Recommended: [`LivingToTell_0.1.48_x64-setup.exe`](https://github.com/sidiangongyuan/living-to-tell/releases/download/living-to-tell-v0.1.48/LivingToTell_0.1.48_x64-setup.exe)
- MSI package: [`LivingToTell_0.1.48_x64_zh-CN.msi`](https://github.com/sidiangongyuan/living-to-tell/releases/download/living-to-tell-v0.1.48/LivingToTell_0.1.48_x64_zh-CN.msi)
