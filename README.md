...
[![Latest release](https://img.shields.io/badge/preview-0.1.47-2563eb?style=flat-square)](https://github.com/sidiangongyuan/living-to-tell/releases/tag/living-to-tell-v0.1.47)
...
[**Download for Windows**](https://github.com/sidiangongyuan/living-to-tell/releases/download/living-to-tell-v0.1.47/LivingToTell_0.1.47_x64-setup.exe)
...
| :---: | :---: |
| ![Article AI edit workspace](tauri-mvp/docs/assets/screenshots/ai-workspace.png) | ![Export and backup center](tauri-mvp/docs/assets/screenshots/backup-center.png) |
...
| **AI Edit** | Article-bound polish, rewrite, expand, and continue tools with explicit model selection, recoverable multi-model runs, one-result reading, paragraph diff, and versioned write-back. |
...
- Recommended: [`LivingToTell_0.1.47_x64-setup.exe`](https://github.com/sidiangongyuan/living-to-tell/releases/download/living-to-tell-v0.1.47/LivingToTell_0.1.47_x64-setup.exe)
- MSI package: [`LivingToTell_0.1.47_x64_zh-CN.msi`](https://github.com/sidiangongyuan/living-to-tell/releases/download/living-to-tell-v0.1.47/LivingToTell_0.1.47_x64_zh-CN.msi)
