...
1. Download the latest Windows preview from [GitHub Releases](https://github.com/sidiangongyuan/living-to-tell/releases/tag/living-to-tell-v0.1.56).
2. Run the recommended installer: `LivingToTell_0.1.56_x64-setup.exe`. The MSI asset is `LivingToTell_0.1.56_x64_zh-CN.msi`.
