...
_CATALOG: dict[str, dict[str, str]] = {
    "en": {
        ...
        "settings.provider_opencode": "OpenCode",
        ...
        "settings.gemini_cli_base_url_hint": "Not used by Gemini CLI / OAuth",
            "settings.opencode_base_url_hint": "Not used by OpenCode CLI",
        ...
        "settings.opencode_missing": "⚠ OpenCode CLI was not found. Install OpenCode and make sure opencode is on PATH.",
        "settings.opencode_ready": "✓ OpenCode CLI found: {path}. Writer will reuse the local OpenCode login.",
        "settings.opencode_auth_missing": "⚠ OpenCode login was not found. Run opencode auth login in a terminal, then retry. Auth path: {path}",
    ...
    "zh_CN": {
        ...
        "settings.gemini_cli_base_url_hint": "Gemini CLI / OAuth 不使用 Base URL",
            "settings.opencode_base_url_hint": "OpenCode CLI 不使用 Base URL",
        ...
        "settings.opencode_missing": "⚠ 未找到 OpenCode CLI。请先安装 OpenCode，并确认 opencode 在 PATH 中。",
        "settings.opencode_ready": "✓ 已找到 OpenCode CLI：{path}。Writer 会复用本机 OpenCode 登录。",
        "settings.opencode_auth_missing": "⚠ 未找到 OpenCode 登录信息。请先在终端运行 opencode auth login。Auth 路径：{path}",
