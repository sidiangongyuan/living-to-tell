...
_CATALOG: dict[str, dict[str, str]] = {
    "en": {
        ...
        "menu.manage_quotes": "Manage &Quotes…",
        "menu.view": "&View",
        ...
        "dates.daily_quote_manage": "Manage quotes",
        "dates.daily_quote_copy": "Copy",
        "dates.daily_quote_empty_title": "No daily quote yet",
        "dates.daily_quote_empty_desc": "Add some quotes to the reference library to see one here each day.",
    ...
    "zh_CN": {
        ...
        "dates.daily_quote_manage": "管理精句",
        "dates.daily_quote_copy": "复制",
        "dates.daily_quote_empty_title": "暂无精句",
        "dates.daily_quote_empty_desc": "去参考库添加名言精句后，这里每天会稳定显示一条。",
        # ── M-RefTypes: typed references ─────────────────────────────────────
