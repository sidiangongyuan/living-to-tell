...
_CATALOG: dict[str, dict[str, str]] = {
    "en": {
        ...
        "menu.manage_quotes": "Reference &Library: Quotes…",
        "menu.view": "&View",
        ...
        "dates.daily_quote_empty_desc": "Mark entries as Quote in the reference library to see one here each day.",
    ...
    "zh_CN": {
        ...
        "dates.daily_quote_empty_desc": "在文脉库里把条目标记为“名言精句”后，这里每天会稳定显示一条。",
        # ── M-RefTypes: typed references ─────────────────────────────────────
