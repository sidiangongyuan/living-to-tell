...
[![Version](https://img.shields.io/badge/version-0.1.55-blue.svg)](CHANGELOG.md)
...
Download the latest public preview from [GitHub Releases](https://github.com/sidiangongyuan/living-to-tell/releases/tag/living-to-tell-v0.1.55).

Recommended Windows asset:

- `LivingToTell_0.1.55_x64-setup.exe`

Optional asset:

- `LivingToTell_0.1.55_x64_zh-CN.msi`
