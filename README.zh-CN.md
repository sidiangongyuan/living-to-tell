...
| 📚 文学图书馆 | 保存摘录、风格标本、人物资料、地点设定、研究材料和个人备注。 |
...
| 🗂️ 文脉标本库 | 人物、地点、设定、摘录、风格标本、查重提示、统计卡片、分类浏览 |
...
- 最新 alpha：[Writer-0.2.0-alpha.15-portable.zip](https://github.com/sidiangongyuan/writer/releases/download/v0.2.0-alpha.15/Writer-0.2.0-alpha.15-portable.zip)
- 发布页：[v0.2.0-alpha.15](https://github.com/sidiangongyuan/writer/releases/tag/v0.2.0-alpha.15)
