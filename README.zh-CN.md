...
[![最新版本](https://img.shields.io/badge/预览版-0.1.49-2563eb?style=flat-square)](https://github.com/sidiangongyuan/living-to-tell/releases/tag/living-to-tell-v0.1.49)
...
[**下载 Windows 安装包**](https://github.com/sidiangongyuan/living-to-tell/releases/download/living-to-tell-v0.1.49/LivingToTell_0.1.49_x64-setup.exe)
 · [English](README.md)
...
| 选择文脉标本 | 对比 AI 结果 |
| :---: | :---: |
| ![文脉标本选择器](tauri-mvp/docs/assets/screenshots/ai-reference-picker.png) | ![文章 AI 修改工作台](tauri-mvp/docs/assets/screenshots/ai-workspace.png) |

| 配好一个可靠的默认模型 | 围绕当前文章讨论 |
| :---: | :---: |
| ![AI 配置档案三步向导](tauri-mvp/docs/assets/screenshots/settings-wizard.png) | ![文章 AI 对话抽屉](tauri-mvp/docs/assets/screenshots/article-ai-chat.png) |
...
| **AI 修改** | 绑定文章或选区的润色、改写、扩写、续写；文脉标本、AI Cards 和文章便签各有同级大选择器，并支持显式模型选择、可恢复多模型任务、段落差异和带版本快照的写回。 |
...
- 推荐安装包：[`LivingToTell_0.1.49_x64-setup.exe`](https://github.com/sidiangongyuan/living-to-tell/releases/download/living-to-tell-v0.1.49/LivingToTell_0.1.49_x64-setup.exe)
- MSI 安装包：[`LivingToTell_0.1.49_x64_zh-CN.msi`](https://github.com/sidiangongyuan/living-to-tell/releases/download/living-to-tell-v0.1.49/LivingToTell_0.1.49_x64_zh-CN.msi)
