...
[![最新版本](https://img.shields.io/badge/预览版-0.1.47-2563eb?style=flat-square)](https://github.com/sidiangongyuan/living-to-tell/releases/tag/living-to-tell-v0.1.47)
...
[**下载 Windows 安装包**](https://github.com/sidiangongyuan/living-to-tell/releases/download/living-to-tell-v0.1.47/LivingToTell_0.1.47_x64-setup.exe)
 · [English](README.md)
...
| 对比 AI 结果 | 检查恢复点 |
| :---: | :---: |
| ![文章 AI 修改工作台](tauri-mvp/docs/assets/screenshots/ai-workspace.png) | ![导出与备份中心](tauri-mvp/docs/assets/screenshots/backup-center.png) |
...
| **AI 修改** | 绑定文章或选区的润色、改写、扩写、续写；支持显式模型选择、可恢复多模型任务、单结果阅读、段落差异和带版本快照的写回。 |
...
- 推荐安装包：[`LivingToTell_0.1.47_x64-setup.exe`](https://github.com/sidiangongyuan/living-to-tell/releases/download/living-to-tell-v0.1.47/LivingToTell_0.1.47_x64-setup.exe)
- MSI 安装包：[`LivingToTell_0.1.47_x64_zh-CN.msi`](https://github.com/sidiangongyuan/living-to-tell/releases/download/living-to-tell-v0.1.47/LivingToTell_0.1.47_x64_zh-CN.msi)
