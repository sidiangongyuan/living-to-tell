...
| 模块 | 功能 |
| --- | --- |
| ✍️ 写作 | 片段编辑、自动保存、标签、片段便签、全文搜索、版本历史、专注模式、字体设置 |
...
- 最新 alpha：[Writer-0.2.0-alpha.33-portable.zip](https://github.com/sidiangongyuan/writer/releases/download/v0.2.0-alpha.33/Writer-0.2.0-alpha.33-portable.zip)
- 发布页：[v0.2.0-alpha.33](https://github.com/sidiangongyuan/writer/releases/tag/v0.2.0-alpha.33)
