...
[![最新版本](https://img.shields.io/badge/预览版-0.1.44-2563eb?style=flat-square)](https://github.com/sidiangongyuan/living-to-tell/releases/tag/living-to-tell-v0.1.44)
...
[**下载 Windows 安装包**](https://github.com/sidiangongyuan/living-to-tell/releases/download/living-to-tell-v0.1.44/LivingToTell_0.1.44_x64-setup.exe)
 · [English](README.md)
...
| **作品集 Agent** | 读取书稿结构、项目记忆和显式 `@` 引用；支持 prompt 索引、后台任务和可确认提案，不会自动改写正文。 |
...
- 推荐安装包：[`LivingToTell_0.1.44_x64-setup.exe`](https://github.com/sidiangongyuan/living-to-tell/releases/download/living-to-tell-v0.1.44/LivingToTell_0.1.44_x64-setup.exe)
- MSI 安装包：[`LivingToTell_0.1.44_x64_zh-CN.msi`](https://github.com/sidiangongyuan/living-to-tell/releases/download/living-to-tell-v0.1.44/LivingToTell_0.1.44_x64_zh-CN.msi)
