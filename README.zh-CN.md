...
| 模块 | 功能 |
| --- | --- |
| ✍️ 写作 | 片段编辑、自动保存、标签、续写提示、全文搜索、版本历史、专注模式、字体设置 |
...
- [x] 片段级续写提示，用来记录下次继续写时的零散灵感，并可作为 AI 续写参考
- [x] 更清楚的续写提示流程：可编辑、完成后不丢失、可把未完成提示带入 AI
- [x] 更紧凑的 TODO 式续写提示，减少对正文空间的挤压
- [x] 续写提示默认收起设置，切换片段时更安静
- [x] UI 设计刷新：语义化主题表面、更清晰的工具栏、安静滚动条和防滚轮误改控件
- [ ] 补齐公开截图、短视频演示和功能预览
- [ ] 常见写作流程的视频教程
- [ ] 新用户首次启动引导
- [ ] 更强的文脉标本分类与自定义视图
...
- 最新 alpha：[Writer-0.2.0-alpha.28-portable.zip](https://github.com/sidiangongyuan/writer/releases/download/v0.2.0-alpha.28/Writer-0.2.0-alpha.28-portable.zip)
- 发布页：[v0.2.0-alpha.28](https://github.com/sidiangongyuan/writer/releases/tag/v0.2.0-alpha.28)
...
- [docs/ui-design-refresh.md](docs/ui-design-refresh.md) - UI 设计刷新方向与人工验收清单
