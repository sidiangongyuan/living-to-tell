...
[![最新版本](https://img.shields.io/badge/预览版-0.1.48-2563eb?style=flat-square)](https://github.com/sidiangongyuan/living-to-tell/releases/tag/living-to-tell-v0.1.48)
...
[**下载 Windows 安装包**](https://github.com/sidiangongyuan/living-to-tell/releases/download/living-to-tell-v0.1.48/LivingToTell_0.1.48_x64-setup.exe)
 · [English](README.md)
...
| **AI 修改** | 绑定文章或选区的润色、改写、扩写、续写；文脉标本拥有一级大选择器，并支持显式模型选择、可恢复多模型任务、段落差异和带版本快照的写回。 |
...
- 运行前可在大尺寸选择器中搜索和筛选文脉标本。只有确认过的标本会被附加，所有模型收到同一份冻结快照；提示词明确禁止照搬原句或移植标本事实、人物和专有名词。
...
- 推荐安装包：[`LivingToTell_0.1.48_x64-setup.exe`](https://github.com/sidiangongyuan/living-to-tell/releases/download/living-to-tell-v0.1.48/LivingToTell_0.1.48_x64-setup.exe)
- MSI 安装包：[`LivingToTell_0.1.48_x64_zh-CN.msi`](https://github.com/sidiangongyuan/living-to-tell/releases/download/living-to-tell-v0.1.48/LivingToTell_0.1.48_x64_zh-CN.msi)
