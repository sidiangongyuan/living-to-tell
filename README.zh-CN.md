...
中文 · [English](README.md) · [下载](https://github.com/sidiangongyuan/living-to-tell/releases/tag/living-to-tell-v0.1.24)
...
[下载 Windows 预览版](https://github.com/sidiangongyuan/living-to-tell/releases/tag/living-to-tell-v0.1.24) · [截图](#截图) · [功能](#功能) · [AI 设置](#ai-设置) · [路线图](#路线图--todo)
...
从 [GitHub Releases](https://github.com/sidiangongyuan/living-to-tell/releases/tag/living-to-tell-v0.1.24) 下载最新公开预览版。
...
2. 在日期页欢迎清单里创建第一篇文章、检查备份，或创建可选示例项目。
3. 打开“文章”开始写作，或打开示例作品集查看完整长篇工作流。
4. 用“作品集”把多篇文章编成阅读顺序并规划大纲。
5. 用“文脉库”保存摘录和出处。
6. 如果需要 AI，在“设置”里配置提供方。
